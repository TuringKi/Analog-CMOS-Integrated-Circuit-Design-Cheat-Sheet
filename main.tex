          ...
          \begin{tikzpicture}
            ...
            \node [mybox] (box){%
                \begin{minipage}{0.3\textwidth}
                  ...
                  A system with $2$ frequency-dependent elements,  th transfer function in complex-frequency form:
                  \begin{equation}
                    H_s =  \frac{ a_0 + a_1s  +a_2s^2 }{  b_1s + b_2s^2     }
                  \end{equation}  
where:
                  \begin{equation}
                    a_0 = H^0
          ...
          \begin{tikzpicture}
            ...
            \node [mybox] (box){%
                ...
                \begin{equation}
                  H_s =  \frac{ a_0 + a_1s + a_2s^2  \cdots +a_ns^n +\cdots  }{ b_1s  + b_2s^2 \cdots +b_ns^n +\cdots     }
                \end{equation}  
           where:
           \begin{equation}
           a_0 = H^0
 ...
 \end{equation} 
  ...
  \begin{center}
                  ...
                  \begin{tikzpicture}[scale=1.00, transform shape, /tikz/circuitikz/bipoles/length=1.50cm, american currents, american voltages, voltage dir=RP]
                    ...
                    \coordinate (D) at (1.1,2.4);
  \coordinate (V_i) at (0,1.4);
  \coordinate (S) at (1.1,0.4);
  \coordinate (V_{out}) at (3.1,2.4);
  \coordinate (1) at (1.1,4.4);
  \coordinate (0) at (1.1,0);
  \coordinate (2) at (1.1,4.42);
 \ctikzset{tripoles/mos style/arrows}
  \draw (1.1,1.4) node[nmos, , xscale=1.0, yscale=1.0, rotate=0] (M1) {$M_{1}$};
  \draw (M1.D) -- (D) (M1.G) -- (V_i) (M1.S) -- (S);
  \draw[-] (D) to (V_{out});
  \draw (D) to [R, bipoles/length=0.90cm, l_={${R_1}$}, n=R] (1);
  \draw[-] (S) to (0);
  \draw[-] (1) to (2);
  \draw (D) node[circ] {};
  \draw (V_i) node[ocirc] {};
  ...
  \draw (0) node[sground] {};
  \draw[anchor=west] (1.3,-0.5) node {ground};
  \draw (2) node[rground, rotate=180] {};
  \draw[anchor=west] (1.3,4.92) node {$V_{\mathrm{DD}}$};
  \draw[anchor=south east] (D) node {D};
  \draw[anchor=south east] (V_i) node {V$_{\mathrm{i}}$};
  \draw[anchor=south east] (S) node {S};
